      ...
      <main className="container py-8 flex-1">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="rounded-lg overflow-hidden bg-white border-2 border-red-300 aspect-square cursor-pointer" onClick={handleImageClick}>
            <img src={isOutOfStock ? '/saiyogi-logo-1.png' : product.image} alt={product.name} className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
          </div>
