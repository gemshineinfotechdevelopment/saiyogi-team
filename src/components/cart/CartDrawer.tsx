          ...
          {items.length > 0 && (
            <div className="p-4 bg-white border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] space-y-3">
              ...
              <div className="flex gap-2 pt-1">
                <a href={`https://wa.me/919488073004?text=${encodeURIComponent(`Hi, I'd like to order crackers worth ₹${estimatedTotal}.`)}`} target="_blank" rel="noopener noreferrer" className="flex-1">
                ...
                <a href="tel:+919488073004" className="flex-1">
