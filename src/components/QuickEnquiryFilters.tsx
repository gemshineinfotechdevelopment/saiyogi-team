...
export const QuickEnquiryFilters: React.FC<QuickEnquiryFiltersProps> = ({
  ...
  return (
    <div className="fixed top-[60px] md:top-[108px] left-0 right-0 z-40 bg-white border-b border-gray-200 shadow-md py-2 sm:py-3 px-2.5 sm:px-4">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-2 sm:gap-4">
          ...
          <div 
            ...
            className="w-full md:w-auto bg-[#A80000] hover:bg-red-800 text-white rounded-xl sm:rounded-2xl px-3.5 sm:px-5 py-1.5 sm:py-2.5 flex items-center justify-between md:justify-start md:gap-5 shadow-md sm:shadow-lg border border-[#8a0000] cursor-pointer hover:scale-105 active:scale-95 transition-all shrink-0"
            title="Click to view Cart & Checkout"
          >
            <div className="flex flex-col text-left">
              <span className="text-[9px] sm:text-[10px] font-extrabold text-white/90 uppercase tracking-wider">Cart Total</span>
              <span className="text-base sm:text-xl font-black leading-tight">₹{totalPrice.toLocaleString('en-IN')}</span>
            </div>
