                  ...
                  <div key={catIdx} className="md:bg-white md:rounded-xl md:shadow-sm md:border md:border-gray-100 overflow-hidden">
                    ...
                    <div className="flex flex-col bg-white font-sans">
                      {group.items.map((item, index) => {
                        ...
                        const mobileView = (
                          <div className={`md:hidden p-1.5 flex gap-2 ${bgColor} border-b border-amber-100/80 last:border-0 mx-1 md:mx-0 rounded-lg md:rounded-none mb-1 md:mb-0 shadow-2xs font-sans`}>
                            <div className="w-[48px] shrink-0 flex flex-col items-center gap-1">
                              <div className="w-[48px] h-[48px] bg-[#FAF2E6] border border-amber-200/60 rounded-xl overflow-hidden flex items-center justify-center cursor-pointer relative" onClick={() => setActiveImage(displayImg)}>
