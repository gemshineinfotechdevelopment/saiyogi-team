  ...
  return (
    <footer className="mt-auto font-body flex flex-col">
      ...
      <a 
        ...
        target="_blank" 
        rel="noopener noreferrer" 
        className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-[#25D366] text-white p-3 sm:px-4 sm:py-3.5 rounded-full shadow-[0_0_20px_rgba(37,211,102,0.6)] hover:shadow-[0_0_30px_rgba(37,211,102,0.9)] hover:scale-110 active:scale-95 transition-all duration-300 z-50 flex items-center gap-2 group"
      >
        <svg className="w-5 h-5 sm:w-6 sm:h-6 fill-current animate-bounce group-hover:animate-none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
